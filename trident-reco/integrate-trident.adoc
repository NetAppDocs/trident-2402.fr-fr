...
| `ontap-nas` | Oui. | Oui. | Yesfootnote:5[] | Oui. | Note de bas de page : 1[] | Oui. | Note de bas de page : 1[] 
...
| `ontap-nas-flexgroup` | Note de bas de page : 1[] | Non | Yesfootnote:5[] | Oui. | Note de bas de page : 1[] | Oui. | Note de bas de page : 1[] 
|===
...
Note :
Yesfootnote:1[] : non géré par Astra Trident
Yesfootnote:2[] : pris en charge pour les volumes en mode bloc brut



=== Pilotes Azure NetApp Files backend

Astra Trident utilise le  `azure-netapp-files` driver pour gérer le link:https://azure.microsoft.com/en-us/products/netapp/["Azure NetApp Files"^] service.
...
| `openshift_metrics_storage_volume_name` | Le nom,
