...
Trident `ontap-nas` et `ontap-san` Des pilotes provisionnent un volume flexible pour chaque volume persistant Kubernetes créé. Le `ontap-nas-economy` Le pilote crée environ un FlexVolume pour chaque 200 PVS (configurable entre 50 et 300). Le `ontap-san-economy` Le pilote crée environ un FlexVolume pour 100 PVS (configurable entre 50 et 200). Pour empêcher Trident de consommer tous les volumes disponibles sur le système de stockage, vous devez définir une limite sur la SVM. Vous pouvez le faire à partir de la ligne de commande :
...
* https://www.netapp.com/pdf.html?item=/media/10507-tr4639.pdf["Configuration de SolidFire pour Linux"^]
...
* https://www.netapp.com/pdf.html?item=/media/10513-tr-4635.pdf["NetApp SolidFire et Cassandra"^]
* https://www.netapp.com/pdf.html?item=/media/10511-tr4606.pdf["Meilleures pratiques pour Oracle sur SolidFire"^]
* https://www.netapp.com/pdf.html?item=/media/10512-tr-4610.pdf["Meilleures pratiques PostgreSQL sur SolidFire"^]
