...
* Trident AutoSupport ne collecte ni ne transmet d'informations personnelles identifiables (PII) ni d'informations personnelles. Il est fourni avec une  https://www.netapp.com/pdf.html?item=/media/14114-enduserlicenseagreementworldwide.pdf["CLUF"^] qui ne s'applique pas à l'image de conteneur Trident elle-même. Vous pouvez en apprendre davantage sur l'engagement de NetApp en matière de sécurité des données et de confiance https://www.netapp.com/pdf.html?item=/media/14114-enduserlicenseagreementworldwide.pdf["ici"^].
