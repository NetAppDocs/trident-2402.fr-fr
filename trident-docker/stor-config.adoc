...
Pour obtenir des informations sur FlexGroups et les charges de travail adaptées à FlexGroups, consultez le https://www.netapp.com/pdf.html?item=/media/12385-tr4571.pdf["NetApp FlexGroup Volume Guide des meilleures pratiques et de mise en œuvre"^].
