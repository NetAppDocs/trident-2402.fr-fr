...
NOTE: Pour mettre à niveau Astra Trident installé à l'aide de l'opérateur à portée d'espace de noms (versions 20.07 à 20.10), utilisez les instructions de mise à niveau pour votre version installée d'Astra Trident.
